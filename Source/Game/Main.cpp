...
INT WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ INT nCmdShow)
{
    ...
    if (FAILED(game->GetRenderer()->AddRenderable(L"BigCube", bigCube)))
    {
        return 0;
    }

    if (FAILED(game->GetRenderer()->SetVertexShaderOfRenderable(L"BigCube", L"MainShader")))
    {
        return 0;
    }

    if (FAILED(game->GetRenderer()->SetPixelShaderOfRenderable(L"BigCube", L"MainShader")))
    {
        return 0;
    }
    ...
    if (FAILED(game->GetRenderer()->AddRenderable(L"SmallCube", smallCube)))
    {
        return 0;
    }
